...
export const Res = add({
  ...
  ports: [
    { name: "p", loc: point(0, 0) },
    { name: "n", loc: point(0, 100) },
  ],
  nameloc: point(10, 0),
  ofloc: point(10, 90),
  defaultNamePrefix: "r",
...
export const Vsource4 = add({
  ...
  ports: [
    { name: "p", loc: point(0, 0) },
    { name: "n", loc: point(0, 100) },
    { name: "cp", loc: point(-40, 25) },
    { name: "cn", loc: point(-40, 75) },
  ],
  nameloc: point(10, 0),
  ofloc: point(10, 90),
...
export const Npn = add({
  ...
  ports: [
    { name: "c", loc: point(0, 0) },
    { name: "b", loc: point(-50, 50) },
    { name: "e", loc: point(0, 100) },
  ],
  nameloc: point(10, 0),
  ofloc: point(10, 90),
